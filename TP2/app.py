...
def get_text2img_pipe(model_id: str, scheduler_name: str):
    # Chargement caché / réutilisé (évite de recharger le modèle à chaque clic)
...
prompt = st.text_area(
    "Prompt",
    value="ultra-realistic e-commerce product photo, studio lighting, soft shadow, clean background, very sharp",
)
